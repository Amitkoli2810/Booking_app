...
const SearchScreen = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
        <View style={{padding:10,margin:10,flexDirection:'row',alignItems:'center',justifyContent:'space-between',borderColor:'#FFC27C',borderWidth:4,borderRadius:10}}>
            <TextInput placeholder='Enter Your Destination' value={input} onChangeText={(e)=>setInput(e)}/>
